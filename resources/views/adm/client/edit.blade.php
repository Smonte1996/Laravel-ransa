            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form action="{{ route('adm.clients.update',$client) }}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="mb-4 col-sm-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('social_reason') is-invalid @enderror"  name="social_reason" id="social_reason"
                                            aria-describedby="social_reasonhelpId" placeholder="Razón Social" value="{{ $client->social_reason }}">
                                        @if ($errors->any())
                                            @error('social_reason')
                                    ...
                                    <div class="mb-4 col-sm-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('ruc') is-invalid @enderror"  name="ruc" id="ruc"
                                            aria-describedby="ruchelpId" placeholder="RUC" value="{{ $client->ruc }}">
                                        @if ($errors->any())
                                            @error('ruc')
