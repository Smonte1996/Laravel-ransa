            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        ...
                        <div class="">
                            <a class="btn-orange-500 btn text-white btn-sm" href="{{ route('adm.roles.index') }}"><i
                            ...
                            <form action="{{ route('adm.roles.store') }}" method="post">
                                ...
                                <div class="row">
                                    <div class="mb-4 col-sm-12 col-md-4">
                                        <label for="" class="form-label fs-6 text-lead-500">Nuevo Rol</label>
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            name="name" id="name" aria-describedby="namehelpId" placeholder="Nuevo Rol"
                                            value="{{ old('name') }}">
                                        @if ($errors->any())
                                            @error('name')
                                                <small id="namehelpId"
