            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form action="{{ route('adm.positions.update',$position) }}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="mb-4 col-sm-12 col-md-4">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"  name="name" id="name"
                                            aria-describedby="namehelpId" placeholder="Editar Rol" value="{{ $position->name }}">
                                        @if ($errors->any())
                                            @error('name')
