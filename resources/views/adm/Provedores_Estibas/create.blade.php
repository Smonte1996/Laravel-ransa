        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>Regitro de Proveedores de estibas</h3>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Registro de Proveedores de estibas</h2>
                                    ...
                                    <div class="mb-3 col-sm-12 col-md-4">
                                        ...
                                        <div class="mb-3 col-sm-12 col-md-4">
                                            ...
                                            <input type="text" class="form-control @error('nombre') is-invalid @enderror"
                                                ...
                                                <div class="mb-3 col-sm-12 col-md-4">
                                                    <label for="" class="form-label fs-6 text-lead-500">Confirmar Password:</label>
                                                    <input type="Password" class="form-control @error('password_confirmation') is-invalid @enderror"
                                                        name="password_confirmation" id="password_confirmation" aria-describedby="password_confirmationhelpId"
                                                        placeholder="Confirmar contraseña" value="{{ old('password_confirmation') }}">
                                                        @error('password_confirmation')
                                                            <small id="password_confirmationhelpId"
                                                                class="form-text text-muted invalid-feedback">{{ $message }}</small>
                                                        @enderror
                                                </div>
                                </div>
