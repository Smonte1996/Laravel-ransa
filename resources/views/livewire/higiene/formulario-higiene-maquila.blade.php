                        ...
                        <div class="row pt-4">
                            ...
                            <div class="col-sm-12 col-md-4">
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <select class="form-control @error('muc') is-invalid @enderror" wire:model.defer="muc" name="muc" id="muc" x-model="textselect">
                                        <option value=" ">Seleccionar una opción</option>
                                         @if (!is_null($this->Infor_ph))
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <input type="text" class="form-control rounded @error('muc1') is-invalid @enderror" wire:model.defer="muc1" placeholder='Actividad que se esta realizando'>
                               </div>
                                </div>

                                <div class="col-sm-12 col-md-2" x-show="textselect== 1">
                                    <div class="mb-3">
                            ...
                            <div class="col-sm-12 col-md-4">
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <select class="form-control @error('mbl') is-invalid @enderror" wire:model.defer="mbl" name="mbl" id="mbl" x-model="textselect">
                                        <option value=" ">Seleccionar una opción</option>
                                        @if (!is_null($this->Infor_ph))
                                        <option value="2">Cumple</option>
                                        <option value="1">No cumple</option>
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <input type="text" class="form-control rounded @error('mbl1') is-invalid @enderror" wire:model.defer="mbl1" placeholder='Actividad que se esta realizando'>
                               </div>
                                </div>
                            ...
                            <div class="col-sm-12 col-md-4">
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <select class="form-control @error('mcl') is-invalid @enderror" wire:model.defer="mcl" name="mcl" id="mcl" x-model="textselect">
                                        <option value=" ">Seleccionar una opción</option>
                                         @if (!is_null($this->Infor_ph))
                                        <option value="2">Cumple</option>
                                        <option value="1">No cumple</option>
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <input type="text" class="form-control rounded @error('mcl1') is-invalid @enderror" wire:model.defer="mcl1" placeholder='Actividad que se esta realizando'>
                               </div>
                                </div>
                            ...
                            <div class="col-sm-12 col-md-4">
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <select class="form-control @error('mna') is-invalid @enderror" wire:model.defer="mna" name="mna" id="mna" x-model="textselect">
                                        <option value=" ">Seleccionar una opción</option>
                                         @if (!is_null($this->Infor_ph))
                                        <option value="2">Cumple</option>
                                        <option value="1">No cumple</option>
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <input type="text" class="form-control rounded @error('mna1') is-invalid @enderror" wire:model.defer="mna1" placeholder='Actividad que se esta realizando'>
                               </div>
                                </div>
                            ...
                            <div class="col-sm-12 col-md-4">
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <select class="form-control @error('mcp') is-invalid @enderror" wire:model.defer="mcp" name="mcp" id="mcp" x-model="textselect">
                                        <option value=" ">Seleccionar una opción</option>
                                        @if (!is_null($this->Infor_ph))
                                        <option value="2">Cumple</option>
                                        <option value="1">No cumple</option>
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <input type="text" class="form-control rounded @error('mcp1') is-invalid @enderror" wire:model.defer="mcp1" placeholder='Actividad que se esta realizando'>
                               </div>
                                </div>
                            ...
                            <div class="col-sm-12 col-md-4">
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <select class="form-control @error('mul') is-invalid @enderror" wire:model.defer="mul" name="mul" id="mul" x-model="textselect">
                                        <option value=" ">Seleccionar una opción</option>
                                         @if (!is_null($this->Infor_ph))
                                        <option value="2">Cumple</option>
                                        <option value="1">No cumple</option>
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <input type="text" class="form-control rounded @error('mul1') is-invalid @enderror" wire:model.defer="mul1" placeholder='Actividad que se esta realizando'>
                               </div>
                                </div>
                            ...
                            <div class="col-sm-12 col-md-4">
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <select class="form-control @error('mnp') is-invalid @enderror" wire:model.defer="mnp" name="mnp" id="mnp" x-model="textselect">
                                        <option value=" ">Seleccionar una opción</option>
                                         @if (!is_null($this->Infor_ph))
                                        <option value="2">Cumple</option>
                                        <option value="1">No cumple</option>
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <input type="text" class="form-control rounded @error('mnp1') is-invalid @enderror" wire:model.defer="mnp1" placeholder='Actividad que se esta realizando'>
                               </div>
                                </div>
                            ...
                            <div class="col-sm-12 col-md-4">
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <select class="form-control @error('mml') is-invalid @enderror" wire:model.defer="mml" name="mml" id="mml" x-model="textselect">
                                        <option value=" ">Seleccionar una opción</option>
                                         @if (!is_null($this->Infor_ph))
                                        <option value="2">Cumple</option>
                                        <option value="1">No cumple</option>
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <input type="text" class="form-control rounded @error('mml1') is-invalid @enderror" wire:model.defer="mml1" placeholder='Actividad que se esta realizando'>
                               </div>
                                </div>
                            ...
                            <div class="col-sm-12 col-md-4">
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <select class="form-control @error('mnaa') is-invalid @enderror" wire:model.defer="mnaa" name="mnaa" id="mnaa" x-model="textselect">
                                        <option value=" ">Seleccionar una opción</option>
                                         @if (!is_null($this->Infor_ph))
                                        <option value="2">Cumple</option>
                                        <option value="1">No cumple</option>
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <input type="text" class="form-control rounded @error('mnaa1') is-invalid @enderror" wire:model.defer="mnaa1" placeholder='Actividad que se esta realizando'>
                               </div>
                                </div>
                            ...
                            <div class="col-sm-12 col-md-4">
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <select class="form-control @error('mub') is-invalid @enderror" wire:model.defer="mub" name="mub" id="mub" x-model="textselect">
                                        <option value=" ">Seleccionar una opción</option>
                                        @if (!is_null($this->Infor_ph))
                                        <option value="2">Cumple</option>
                                        <option value="1">No cumple</option>
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <input type="text" class="form-control rounded @error('mub1') is-invalid @enderror" wire:model.defer="mub1" placeholder='Actividad que se esta realizando'>
                               </div>
                                </div>
                            ...
                            <div class="col-sm-12 col-md-4">
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <select class="form-control @error('mcb') is-invalid @enderror" wire:model.defer="mcb" name="mcb" id="mcb" x-model="textselect">
                                        <option value=" ">Seleccionar una opción</option>
                                         @if (!is_null($this->Infor_ph))
                                        <option value="2">Cumple</option>
                                        <option value="1">No cumple</option>
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <input type="text" class="form-control rounded @error('mcb1') is-invalid @enderror" wire:model.defer="mcb1" placeholder='Actividad que se esta realizando'>
                               </div>
                                </div>
                            ...
                            <div class="col-sm-12 col-md-4">
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <select class="form-control @error('mbe') is-invalid @enderror" wire:model.defer="mbe" name="mbe" id="mbe" x-model="textselect">
                                        <option value=" ">Seleccionar una opción</option>
                                         @if (!is_null($this->Infor_ph))
                                        <option value="2">Cumple</option>
                                        <option value="1">No cumple</option>
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <input type="text" class="form-control rounded @error('mbe1') is-invalid @enderror" wire:model.defer="mbe1" placeholder='Actividad que se esta realizando'>
                               </div>
                                </div>
                            ...
                            <div class="col-sm-12 col-md-4">
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <select class="form-control @error('mhg') is-invalid @enderror" wire:model.defer="mhg" name="mhg" id="mhg" x-model="textselect">
                                        <option value=" ">Seleccionar una opción</option>
                                         @if (!is_null($this->Infor_ph))
                                        <option value="2">Cumple</option>
                                        <option value="1">No cumple</option>
                               ...
                               <div class="col-sm-12 col-md-3">
                                <div class="mb-3">
                                    <input type="text" class="form-control rounded @error('mhg1') is-invalid @enderror" wire:model.defer="mhg1" placeholder='Actividad que se esta realizando'>
                               </div>
                                </div>
